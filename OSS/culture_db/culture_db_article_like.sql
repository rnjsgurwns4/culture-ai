...
CREATE TABLE `article_like` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKm53glexu2qqiox2iajqsxhmaw` (`article_id`,`member_id`),
  KEY `FK2884un1viom7eflnk794rh8wv` (`member_id`),
  CONSTRAINT `FK2884un1viom7eflnk794rh8wv` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`),
...
INSERT INTO `article_like` VALUES (3,128,52),(2,143,52),(5,234,52),(4,281,2),(1,281,52);
